...
* ⚠️ Sandbox requires external TURN server (not included). Alternatively, you can upgrade your plan to get a built-in TURN.
* ⚠️ The Sandbox environment uses a community-shared PulseBeam Cloud auth token endpoint. It is an auth endpoint using @pulsebeam/server SDK.
